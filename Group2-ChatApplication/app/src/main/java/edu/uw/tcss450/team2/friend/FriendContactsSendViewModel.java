...
public class FriendContactsSendViewModel extends AndroidViewModel {

    private final MutableLiveData<JSONObject> mResponse;

    public FriendContactsSendViewModel(@NonNull Application application) {
        super(application);
